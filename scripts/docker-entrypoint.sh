...
# ÉTAPE 1 — Installer les dépendances Node.js (si nécessaire)
...
# ÉTAPE 2 — Build Next.js (export statique, si out/ absent)
...
if [ ! -d "out" ]; then
  ...
  log_step "Dossier out/ existant détecté — étape build ignorée"
fi
